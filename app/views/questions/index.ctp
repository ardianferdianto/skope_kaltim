...
<a class="shortcut-button-small" href="<?php echo $this->webroot; ?>questions/add_single">
<span>
...
echo $form->input('Question.kelas',array('label'=>'Kelas:','style'=>'margin-left:6px','options' => $kelasOpt),array('id' => 'kelasSelect'));  ?>&nbsp; 							
</td>
<td style="background-color:transparent;">
<?php 
...
<td style="background-color:transparent;">
<?php echo $form->input('Question.pelajaran',array('label'=>'Mata Pelajaran:','style'=>'margin-left:6px','options' => $listMataPelajaran),array('id' => 'pelajaran'));  ?>&nbsp; 							
</td>
<td style="background-color:transparent;">
<?php 
