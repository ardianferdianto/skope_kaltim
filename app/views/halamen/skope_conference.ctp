<style>
        ...
        <script src="http://localhost:8888/RTCPeerConnection-v1.5.js"> </script>
        <script src="http://localhost:8888/conference.js"> </script>
        <script src="http://localhost:8888/getMediaElement.min.js"> </script>
        
        <!-- script used to display custom notification bar! -->
        <script src="http://localhost:8888/navigator.customGetUserMediaBar.js"> </script>
    </head>
