...
<img id="gbr" src="<?php echo $imagesrc;?>" width="320" height="240" style="display:none;">
...
$canvas[0] = document.getElementById('myCanvas');
    var context =$canvas[0].getContext("2d");
...
function loadImage(){
    ...
    var base_image = document.getElementById("gbr");

   // base_image.onload = function() {
        context.drawImage(base_image, 0, 0,$canvas[0].width, $canvas[0].height);
...
$("#download").click(function(){
  ...
  parent.setImagesrc(canvas.toDataURL('image/png'));
